...
const Restaurants: React.FC<Props> = (props) => {
  ...
  return (
    <div
      className={`w-full text-center mx-auto flex items-center max-w-[764px] small-mobile md:max-w-[850px] lola55`}
    ...
    >
      ...
      <div className="bg-[#FFD700 ] golda px-4 py-4 relative w-full rounded-[31px] mt-10 h-auto">
        <div className="absolute w-6 h-6 z-40 right-0 top-0 bottom-0 my-auto -translate-x-2">
          <Triangle givenclass="rotate-180" />
        </div>
        <Slot
          slotTransition={slotTransition}
          refindex={1}
          firstMessage={firstMessage}
          firstMessageEffect={firstMessageEffect}
        />
